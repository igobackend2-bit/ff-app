...
export const VALLUVAM_CATALOG: CatalogCategory[] = [
  {
    ...
    sortOrder: 10,
    products: [
      { name: 'Valluvam Honey', unit: '250GM', price: 230, imageFile: 'honey.jpeg', featured: true },
      { name: 'Valluvam Honey', unit: '500GM', price: 440, imageFile: 'honey.jpeg', featured: false },
      { name: 'Palm Jaggery (Karupatti)', unit: '500GM', price: 330, imageFile: 'palm-jaggery(500).jpeg', featured: true },
      { name: 'Palm Jaggery (Karupatti)', unit: '1KG', price: 640, imageFile: 'palm-jaggery.jpeg', featured: false },

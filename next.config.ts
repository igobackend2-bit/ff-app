...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "font-src 'self'",
      "connect-src 'self' https://api.razorpay.com https://lumberjack.razorpay.com https://vitals.vercel-insights.com https://*.supabase.co https://sandbox.cashfree.com https://api.cashfree.com https://*.cashfree.com",
      "frame-src https://api.razorpay.com https://checkout.razorpay.com https://sandbox.cashfree.com https://payments.cashfree.com https://*.cashfree.com",

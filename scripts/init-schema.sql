...
CREATE TABLE "Product" (
    ...
    "blurDataUrls" TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE "Order" (
    ...
    "darkStoreId" TEXT NOT NULL DEFAULT 'default-store',
...
-- CreateIndex
CREATE UNIQUE INDEX "Inventory_productId_darkStoreId_key" ON "Inventory"("productId", "darkStoreId");

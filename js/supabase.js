/* supabase.js â Farmers Factory
 * Requires: <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>
 * loaded BEFORE this file.
 *
 * â  PASTE YOUR FULL SUPABASE ANON KEY BELOW (from Supabase â Settings â API)
 */
var SUPABASE_URL = 'https://qwiumswrbddwmlraktvy.supabase.co';

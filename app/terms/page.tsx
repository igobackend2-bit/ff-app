...
const SECTIONS = [
  ...
  { title: '3. Account Registration', body: 'You are responsible for maintaining the confidentiality of your account credentials. You are liable for all activities that occur under your account. Notify us immediately at support@farmersfactory.in if you suspect unauthorised access.' },
  ...
  { title: '12. Contact', body: 'For queries about these terms, contact legal@farmersfactory.in or write to Farmers Factory Technologies Pvt. Ltd., 12th Floor, Prestige Tech Park, Marathahalli, Bangalore – 560037.' },
];

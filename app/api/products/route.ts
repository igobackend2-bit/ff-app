...
export async function GET(req: NextRequest) {
  try {
    ...
    // Build orderBy — sortOrder field now in Prisma schema (run `npx prisma db push` once)
    // sortOrder=0 means unset → sorts last via CASE; positive int = explicit admin order
